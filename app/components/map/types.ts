...
export type MapDataSource = { provider: "Росстат"; dataset: "БД ПМО"; indicatorCode: "8112027"; asOf: "2025-01-01"; url: string };
export type MapData = { updatedAt: string; source?: MapDataSource; geography: { type: "FeatureCollection"; features: Municipality[] }; cities: City[] };
